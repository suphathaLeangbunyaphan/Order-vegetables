...
<div class="clear"></div>
<div class="box">
    <center><h1>แก้ไขข้อมูลผักสลัด</h1></center>
    </div>
    <div class="box1">
    <form action="upvaphp.php" method="POST" enctype="multipart/form-data">
 <?php $id=$_POST['id'];
 $svv="select*from salad where s_id='$id'";
 $qsvv=mysqli_query($dbcon,$svv);
$iqs=mysqli_fetch_array($qsvv,MYSQLI_ASSOC);
 ?>
    ชื่อผักสลัด:<br><input class="b"type="text" name="name" value="<?php echo $iqs['s_name'];?>" required><br>
    จำนวน(หน่วยเป็นกิโลกรัม):<br><input type="text" class="b" name="q" value="<?php echo $iqs['s_quantity'];?>"required><br>
    ราคา:<br><input type="text" class="b" name="price" value="<?php echo $iqs['s_price'];?>"  required><br>
    
</div>
   <div class="box2">
        วันที่เริ่ม:<br><input type="date" name="date" value="<?php echo $iqs['s_datebegin'];?>" class="b" required><br>
...
<center>
        <input type="submit" class="submit" value="แก้ไข"><input type="hidden" name="id" value="<?php echo $id;?>">
        </center>
</div>
    </form>
    <div class="infofm">
...
?>
  <tr>
    ...
    <td><form method="post"action="updateva.php"><input type="submit" value="แก้ไข"><input type="hidden" name="id" value="<?php echo $info['s_id'];?>"></form></a></td> 
    <td><form method="post"action="deleteva.php"><input type="submit" value="ลบ"><input type="hidden" name="id" value="<?php echo $info['s_id'];?>"></form></a></td> 
 </tr>
